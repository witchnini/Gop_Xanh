...
HTTP smoke chỉ xác nhận phản hồi các đường dẫn, không xác nhận nghiệp vụ lưu dữ liệu hoặc quyền truy cập. Chưa kiểm chứng đồng bộ/triển khai cấu trúc mới trên Lovable.
